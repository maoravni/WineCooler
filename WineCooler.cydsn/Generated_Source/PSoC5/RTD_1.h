...
#define     RTD_1_ORDER_POS   (0x3u)
#define     RTD_1_POS_INPUT_SCALE   (9)
#define     RTD_1_POS_COEFF_SCALE   (11)
#define     RTD_1_ORDER_NEG   (0x3u)
#define     RTD_1_NEG_INPUT_SCALE   (9)
#define     RTD_1_NEG_COEFF_SCALE   (11)
